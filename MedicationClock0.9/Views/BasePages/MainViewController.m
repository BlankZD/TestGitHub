...
-(void)initView{
   ...
   // bgimageview.image=[UIImage imageNamed:@"hub2_bg.png"];
    ...
    UIButton *bsBtn=[[UIButton alloc] initWithFrame:CGRectMake( screenWidth/24*5, screenHeight/5, screenWidth*7/24, screenWidth*7/24) ];
    ...
    UIButton *ckBtn=[[UIButton alloc] initWithFrame:CGRectMake(screenWidth*17.5/48, screenHeight/4+screenHeight/56.8*4, screenWidth*7/24, screenWidth*7/24)];
