...
- (void)viewDidLoad {
    ...
    //状态栏底部颜色
    UILabel *status = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, screenWidth, statusHeight)];
    status.backgroundColor = [UIColor blackColor];
    [self.view addSubview:status];
   
    
    UILabel *title = [[UILabel alloc]initWithFrame:CGRectMake(screenWidth/3, screenHeight/6, screenWidth/2, screenHeight/56.8*3)];
    title.backgroundColor = [UIColor clearColor];
    title.textColor = [UIColor whiteColor];
    title.font = [UIFont fontWithName:@"Arial-BoldItalicMT" size:35*SizeScale];
    title.text = @"邦林康＋";
    ...
    label1.text = @"  账号";
    _usernameView = [[UITextField alloc]initWithFrame:CGRectMake(screenWidth/6, screenHeight/3.5, screenWidth*2/3, screenHeight*11/120)];
    ...
    _usernameView.placeholder = @"用户名／邮箱";
    _usernameView.font=[UIFont systemFontOfSize:14];
    ...
    label2.text = @"  密码";
    _passwordView = [[UITextField alloc]initWithFrame:CGRectMake(screenWidth/6, screenHeight/3.5+screenHeight*11/120+5*SizeScale, screenWidth*2/3, screenHeight*11/120)];
    ...
    _passwordView.font=[UIFont systemFontOfSize:14];
    _passwordView.leftViewMode = UITextFieldViewModeAlways;
    _passwordView.returnKeyType = UIReturnKeyDone;
    [self.view addSubview:_passwordView];
    UIImageView *bgimageview1=[[UIImageView  alloc]initWithFrame:CGRectMake(3.5*screenHeight/56.8, _passwordView.frame.origin.y+_passwordView.frame.size.height+2.5*screenHeight/56.8, screenWidth-7*screenHeight/56.8,  4*screenHeight/56.8)];
    bgimageview1.image=[UIImage imageNamed:@"zi.png"];
    [self.view addSubview:bgimageview1];
    
    //添加注册登录的按钮
    UIButton *loginBtn=[[UIButton alloc] initWithFrame:CGRectMake(screenWidth*6/32 ,_passwordView.frame.origin.y+_passwordView.frame.size.height+11*screenHeight/56.8, screenWidth*20/32, 4*screenHeight/56.8)];
    loginBtn.backgroundColor = [UIColor btnBlueColor];
    loginBtn.layer.cornerRadius = 10;
    loginBtn.titleLabel.font  = [UIFont systemFontOfSize: 18*SizeScale];
    ...
    registBtn.titleLabel.font    = [UIFont systemFontOfSize: 14*SizeScale];
    ...
    [registBtn setFrame:CGRectMake(screenWidth*26/32, loginBtn.frame.origin.y+loginBtn.frame.size.height+2.8*screenHeight/56.8, registBtn_labelSize.width, registBtn_labelSize.height)];
    //添加按钮到视图
