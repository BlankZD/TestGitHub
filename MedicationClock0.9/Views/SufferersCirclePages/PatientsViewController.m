...
- (void)viewDidLoad {
    ...
    [cateNameArray addObject:@"谁能看我"];
    [cateNameArray addObject:@"我能看谁"];
...
-(void)initTagView:(NSArray*)cateNameArray{
    ...
    for (int i = 0; i < cateNameArray.count; i++) {
        ...
        [nameBtn setTitleColor:[UIColor btnBlueColor] forState:UIControlStateNormal];
        ...
        if (i == 0) {
            ...
            _lineView = [[UIView alloc] initWithFrame:CGRectMake(nameBtn.frame.origin.x, 38, btnWidth, 5)];
...
-(void)initSrollView{
   ...
   // _scrollView.backgroundColor = [UIColor myBgColor];
...
-(UITableViewCell *)customCellWithOutXib:(UITableView *)tableView withIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell == nil){
        ...
        //图片
        CGRect imageRect = CGRectMake(screenWidth/32*1.5, screenHeight/50*1.5, screenWidth/32*3, screenHeight/50*3);
        ...
        //用户名
        CGRect userNameTipRect = CGRectMake(screenWidth/32*6, screenHeight/50*1.5, screenWidth/32*6, screenHeight/50*1.4);
        UILabel *userNameTipLabel = [[UILabel alloc]initWithFrame:userNameTipRect];
        userNameTipLabel.text = @"用户名:";
        userNameTipLabel.textColor = [UIColor whiteColor];
        userNameTipLabel.font = [UIFont boldSystemFontOfSize:15];
        [cell.contentView addSubview:userNameTipLabel];
        
        
        CGRect userNameRect = CGRectMake(screenWidth/32*12, screenHeight/50*1.5, screenWidth/32*4, screenHeight/50*1.4);
        ...
        //昵称
        CGRect nickNameTipRect = CGRectMake(screenWidth/32*6, screenHeight/50*3.5, screenWidth/32*4, screenHeight/50*1.5);
        ...
        nickNameTipLabel.textColor = [UIColor whiteColor];
        [cell.contentView addSubview:nickNameTipLabel];
        
        CGRect nickNameRect = CGRectMake(screenWidth/32*12, screenHeight/50*3.5, screenWidth/32*15, screenHeight/50*1.4);
