...
-(void)defaultInit{
    ...
    //正常状态下的按钮背景图片
    //    [_button setImage:[UIImage imageNamed:@"RadioButton_Not_check.png"] forState:UIControlStateNormal];
    [_button setImage:[UIImage imageNamed:@"tabswitcher_long.png"] forState:UIControlStateNormal];
    //选择状态下的按钮背景图片
    //    [_button setImage:[UIImage imageNamed:@"RadioButton_check.png"] forState:UIControlStateSelected];
    [_button setImage:[UIImage imageNamed:@"tabswitcher_short.png"] forState:UIControlStateSelected];
    //添加按钮监听事件
