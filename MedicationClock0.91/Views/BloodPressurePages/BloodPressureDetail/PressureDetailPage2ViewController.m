//
//  PressureDetailPage2ViewController.m
//  MedicationClockTest
//
...
@interface PressureDetailPage2ViewController ()

@end

@implementation PressureDetailPage2ViewController{
    int y0;
    int screenWidth;
    int screenHeight;
...
- (void)viewDidLoad {
    ...
    NSDictionary *weekDic = [BloodPressureDB queryRecent:dbDriver type:0];
    NSDictionary *monthDic = [BloodPressureDB  queryRecent:dbDriver type:1];
    NSDictionary *yearDic = [BloodPressureDB  queryRecent:dbDriver type:2];
...
- (void)initViewWithData_week:(NSDictionary*)weekDic month:(NSDictionary*)monthDic year:(NSDictionary*)yearDic{
    ...
    //scrollView.backgroundColor=[UIColor myBgColor];
    ...
    weeklyReportView.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.2];
    ...
    weeklyReportTitle.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    NSString *bloor_suger_value_str = [weekDic valueForKey:@"systolic_pressure_average"];
    ...
    weeklyReportAverage.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString *before_high_times_str = [weekDic valueForKey:@"systolic_pressure_hypertension_times"];
    if(before_high_times_str==nil){
        weeklyReportHigh.text=[NSString stringWithFormat:@"高于140mmHg:0次"];
    }else{
        weeklyReportHigh.text=[NSString stringWithFormat:@"高于140mmHg:%@次", before_high_times_str];
    }
    
    weeklyReportHigh.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString *before_low_times_str = [weekDic valueForKey:@"systolic_pressure_hypotension_times"];
    if(before_low_times_str==nil){
        weeklyReportLow.text=[NSString stringWithFormat:@"低于90mmHg:0次"];
    }else{
        weeklyReportLow.text=[NSString stringWithFormat:@"低于90mmHg:%@次", before_low_times_str];
    }
    
    weeklyReportLow.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    weeklyReportZhou.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    mouthlyReportView.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.2];
    ...
    mouthlyReportYue.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    [mouthlyReportYue setFrame:CGRectMake(screenWidth/32.0*3.3, screenWidth/10.0, mouthlyReportYueSize.width, mouthlyReportYueSize.height)];
    
    
    UILabel *mouthlyReportTitle = [[UILabel alloc]init];
    mouthlyReportTitle.text=@"月报告";
    mouthlyReportTitle.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    NSString *mouth_bloor_suger_value_str = [monthDic valueForKey:@"systolic_pressure_average"];
    ...
    mouthlyReportAverage.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString *month_before_high_times_str = [monthDic valueForKey:@"systolic_pressure_hypertension_times"];
    if(month_before_high_times_str==nil){
        mouthlyReportHigh.text=[NSString stringWithFormat:@"高于140mmHg:0次"];
    }else{
        mouthlyReportHigh.text=[NSString stringWithFormat:@"高于140mmHg:%@次", month_before_high_times_str];
    }
    
    
    mouthlyReportHigh.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString * month_before_low_times_str = [monthDic valueForKey:@"systolic_pressure_hypotension_times"];
    if(month_before_low_times_str==nil){
        mouthlyReportLow.text=[NSString stringWithFormat:@"低于90mmHg:0次"];
    }else{
        mouthlyReportLow.text=[NSString stringWithFormat:@"低于90mmHg:%@次", month_before_low_times_str];
    }
    mouthlyReportLow.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    yearlyReportView.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.2];
    ...
    yearlyReportTitle.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    [yearlyReportTitle setFrame:CGRectMake(screenWidth/22*2,screenHeight/50.0*0.8, yearlyReportTitleSize.width, yearlyReportTitleSize.height)];
    
    UILabel *yearlyReportAverage = [[UILabel alloc]init];
    
    NSString * year_bloor_suger_value_str = [yearDic valueForKey:@"systolic_pressure_average"];
    ...
    yearlyReportAverage.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString * year_before_high_times_str = [yearDic valueForKey:@"systolic_pressure_hypertension_times"];
    if(year_before_high_times_str==nil){
        yearlyReportHigh.text=[NSString stringWithFormat:@"高于140mmHg:0次"];
    }else{
        yearlyReportHigh.text=[NSString stringWithFormat:@"高于140mmHg/L:%@次", year_before_high_times_str];
    }
    yearlyReportHigh.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString * year_before_low_times_str = [yearDic valueForKey:@"systolic_pressure_hypotension_times"];
    if(year_before_low_times_str==nil){
        yearlyReportLow.text=[NSString stringWithFormat:@"低于90mmHg:0次"];
    }else{
        yearlyReportLow.text=[NSString stringWithFormat:@"低于90mmHg:%@次", year_before_low_times_str];
    }
    yearlyReportLow.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    yearlyReportZhou.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    title2Label.text=@"舒张压";
    title2Label.font=[UIFont systemFontOfSize:20*screenWidth/320];
    ...
    //舒张压周报告
    UIView *weeklyReportView1 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/22.0, screenHeight/50.0*44.5, screenWidth-screenWidth/22.0*2, screenHeight/50.0*8.5)];
    weeklyReportView1.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.2];
    ...
    weeklyReportTitle1.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    NSString *after_bloor_suger_value_str = [weekDic valueForKey:@"diastolic_pressure_average"];
    ...
    weeklyReportAverage1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString *after_high_times_str = [weekDic valueForKey:@"diastolic_pressure_hypertension_times"];
    if(after_high_times_str==nil){
        weeklyReportHigh1.text=[NSString stringWithFormat:@"高于90mmHg:0次"];
    }else{
        weeklyReportHigh1.text=[NSString stringWithFormat:@"高于90mmHg:%@次", after_high_times_str];
    }
    weeklyReportHigh1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    [weeklyReportHigh1 setFrame:CGRectMake(screenWidth/22.0*2, screenHeight/50.0*4.3, weeklyReportHigh1Size.width, weeklyReportHigh1Size.height)];
    
    UILabel *weeklyReportLow1 = [[UILabel alloc]init];
    
    NSString *after_low_times_str = [weekDic valueForKey:@"diastolic_pressure_hypotension_times"];
    if(after_low_times_str==nil){
        weeklyReportLow1.text=[NSString stringWithFormat:@"低于60mmHg:0次"];
    }else{
        weeklyReportLow1.text=[NSString stringWithFormat:@"低于60mmHg:%@次", after_low_times_str];
    }
    
    weeklyReportLow1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    weeklyReportLow1.textColor=[UIColor whiteColor];
    [weeklyReportView1 addSubview:weeklyReportLow1];
    CGSize weeklyReportLow1Size = [weeklyReportLow1.text sizeWithFont:weeklyReportLow1.font];
    [weeklyReportLow1 setFrame:CGRectMake(screenWidth/22.0*2, screenHeight/50.0*5.8, weeklyReportLow1Size.width, weeklyReportLow1Size.height)];
    
    //周状况Lable
    UILabel *weeklyReportZhou1 = [[UILabel alloc]init];
    weeklyReportZhou1.text=@"良好   ";
    weeklyReportZhou1.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    [weeklyReportZhou1 setFrame:CGRectMake(screenWidth/32.0*22.7, screenWidth/10.0*1.2, weeklyReportZhou1Size.width, weeklyReportZhou1Size.height)];
    ...
    mouthlyReportView1.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.2];
    ...
    mouthlyReportYue1.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    [mouthlyReportYue1 setFrame:CGRectMake(screenWidth/32.0*3.2, screenWidth/10.0, mouthlyReportYue1Size.width, mouthlyReportYue1Size.height)];
    
    
    UILabel *mouthlyReportTitle1 = [[UILabel alloc]init];
    mouthlyReportTitle1.text=@"月报告";
    mouthlyReportTitle1.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    NSString *mouth_bloor_suger_value_str1 = [monthDic valueForKey:@"diastolic_pressure_average"];
    ...
    mouthlyReportAverage1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString *after_high_times_str1 = [monthDic valueForKey:@"diastolic_pressure_hypertension_times"];
    if(after_high_times_str1==nil){
        mouthlyReportHigh1.text=[NSString stringWithFormat:@"高于90mmHg:0次"];
    }else{
        mouthlyReportHigh1.text=[NSString stringWithFormat:@"高于90mmHg:%@次", after_high_times_str1];
    }
    
    mouthlyReportHigh1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    [mouthlyReportHigh1 setFrame:CGRectMake(screenWidth/2.0, screenHeight/50.0*4.3, mouthlyReportHigh1Size.width, mouthlyReportHigh1Size.height)];
    UILabel * mouthlyReportLow1 = [[UILabel alloc]init];
    NSString * month_after_low_times_str = [monthDic valueForKey:@"diastolic_pressure_hypotension_times"];
    if(month_after_low_times_str==nil){
        mouthlyReportLow1.text=[NSString stringWithFormat:@"低于60mmHg:0次"];
    }else{
        mouthlyReportLow1.text=[NSString stringWithFormat:@"低于60mmHg:%@次", month_after_low_times_str];
    }
    mouthlyReportLow1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    mouthlyReportLow1.textColor=[UIColor whiteColor];
    [mouthlyReportView1 addSubview:mouthlyReportLow1];
    CGSize mouthlyReportLow1Size = [mouthlyReportLow1.text sizeWithFont:mouthlyReportLow1.font];
    [mouthlyReportLow1 setFrame:CGRectMake(screenWidth/2.0, screenHeight/50.0*5.8, mouthlyReportLow1Size.width, mouthlyReportLow1Size.height)];
    ...
    yearlyReportView1.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.2];
    ...
    yearlyReportTitle1.font=[UIFont systemFontOfSize:17*screenWidth/320];
    ...
    NSString *year_bloor_suger_value_str1 = [yearDic valueForKey:@"diastolic_pressure_average"];
    ...
    yearlyReportAverage1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    NSString *after_high_times_str2 = [yearDic valueForKey:@"diastolic_pressure_hypertension_times"];
    if(after_high_times_str2==nil){
        yearlyReportHigh1.text=[NSString stringWithFormat:@"高于90mmHg:0次"];
    }else{
        yearlyReportHigh1.text=[NSString stringWithFormat:@"高于90mmHg:%@次", after_high_times_str2];
    }
    yearlyReportHigh1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    ...
    [yearlyReportHigh1 setFrame:CGRectMake(screenWidth/22.0*2, screenHeight/50.0*4.3, yearlyReportHigh1Size.width, yearlyReportHigh1Size.height)];
    
    
    UILabel *yearlyReportLow1 = [[UILabel alloc]init];
    NSString * year_after_low_times_str = [yearDic valueForKey:@"diastolic_pressure_hypotension_times"];
    if(year_after_low_times_str==nil){
        yearlyReportLow1.text=[NSString stringWithFormat:@"低于60mmHg:0次"];
    }else{
        yearlyReportLow1.text=[NSString stringWithFormat:@"低于60mmHg:%@次", year_after_low_times_str];
    }
    yearlyReportLow1.font=[UIFont systemFontOfSize:12*screenWidth/320];
    yearlyReportLow1.textColor=[UIColor whiteColor];
    [yearlyReportView1 addSubview:yearlyReportLow1];
    CGSize yearlyReportLow1Size = [yearlyReportLow1.text sizeWithFont:yearlyReportLow1.font];
    [yearlyReportLow1 setFrame:CGRectMake(screenWidth/22.0*2, screenHeight/50.0*5.8, yearlyReportLow1Size.width, yearlyReportLow1Size.height)];
    
    ;
    //年状况Lable
    UILabel *yearlyReportZhou1 = [[UILabel alloc]init];
    yearlyReportZhou1.text=@"良好   ";
    yearlyReportZhou1.font=[UIFont systemFontOfSize:17*screenWidth/320];
