...
-(void)initView{
    ...
    UIView *lineView1 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/66.0+layer.frame.origin.x+layer.frame.size.width, layer.frame.origin.y+screenHeight/50*2, screenWidth/32.0*20.5, 1)];
    lineView1.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    ...
    [birthdayLabel setFrame:CGRectMake(screenWidth/66.0+layer.frame.origin.x+layer.frame.size.width, y0+screenHeight/50.0*8, birthdayLabelSize.width, birthdayLabelSize.height)];
    ...
    UIView *lineView2 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*14, screenWidth/32.0*29, 1)];
    ...
    UIView *lineView3 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*18, screenWidth/32.0*29, 1)];
    lineView3.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    ...
    UIView *lineView4 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*22, screenWidth/32.0*29, 1)];
    lineView4.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    ...
    UIView *lineView5 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*26, screenWidth/32.0*29, 1)];
    lineView5.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    ...
    UIView *lineView6 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*34, screenWidth/32.0*29, 1)];
    lineView6.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    ...
    UIView *lineView7 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*30, screenWidth/32.0*29, 1)];
    lineView7.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    ...
    UIView *lineView8 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*38, screenWidth/32.0*29, 1)];
    lineView8.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
    ...
    UIView *lineView9 = [[UIView alloc]initWithFrame:CGRectMake(screenWidth/32.0*1.5, y0+screenHeight/50.0*42, screenWidth/32.0*29, 1)];
    lineView9.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
            ...
            [loadingAlert dismissViewControllerAnimated:YES completion:^() {
                ...
                if ([data length] > 0 && error == nil) {
                    ...
                    if(error==nil){       //如果json解析正确
                        ...
                        [phoneView setFrame:CGRectMake(screenWidth-phoneSize.width-screenWidth/22.0, y0+screenHeight/50.0*32, phoneSize.width, phoneSize.height)];
