//
//  PatientBloodSugarViewController.m
//  MedicationClockTest
//
...
@interface PatientBloodSugarViewController ()<MyCalendarViewDelegate, UITableViewDataSource,UITableViewDelegate>

@end

@implementation PatientBloodSugarViewController{
    int y0;
    int screenWidth;
    int screenHeight;
...
-(void)getMarkDate:(NSString*)yearAndMonth calendarView:(MyCalendarView*)calendarView{
    NSString *urlStr = [NSString stringWithFormat:@"%@!selectSugarState.ac", ClockActionUrl];
...
-(void)selectDate:(NSString*)dateStr{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@!selectSugarByDate.ac", ClockActionUrl];
...
-(UITableViewCell *)customCellWithOutXib:(UITableView *)tableView withIndexPath:(NSIndexPath *)indexPath{
    ...
    [label3 setFrame:CGRectMake(screenWidth-label3Size.width-20, (45-label3Size.height)/2, label3Size.width, label3Size.height)];
    ...
    [label2 setFrame:CGRectMake(label3.frame.origin.x-label2Size.width-10, (45-label2Size.height)/2, label2Size.width, label2Size.height)];
