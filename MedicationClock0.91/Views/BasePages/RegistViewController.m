...
- (void)viewDidLoad {
    ...
    //设置主标题的颜色
    [[UINavigationBar appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor]}];    //设置导航栏字体的颜色
    ...
    [self.navigationController.navigationBar addSubview:status];    //背景图
   ...
   // _usernameView.rightViewMode = UITextFieldViewModeAlways;
    ...
    _usernameView.clearButtonMode = UITextFieldViewModeAlways;
    //typedef enum {
    ...
    _passwordView.clearButtonMode = UITextFieldViewModeAlways;
    //typedef enum {
    ...
    UILabel *label3 = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 80, 25)];
    ...
    _confirmpwdView.font=[UIFont systemFontOfSize:14];
    ...
    _confirmpwdView.placeholder = @"确认密码";
    ...
    _confirmpwdView.clearButtonMode = UITextFieldViewModeAlways;
    [self.view addSubview:_confirmpwdView];
    
    
    UILabel *label4 = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 80, 25)];
    ...
    _nicknameView.font=[UIFont systemFontOfSize:14];
