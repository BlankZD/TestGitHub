...
- (void)viewDidLoad {
    ...
    UIImageView *bgimageview=[[UIImageView  alloc]initWithFrame:CGRectMake(0, y0+TOP_TAG_HEIGHT, screenWidth,  screenHeight+y0)];
...
-(void)initTagView:(NSArray*)cateNameArray{
    ...
    for (int i = 0; i < cateNameArray.count; i++) {
        ...
        if (i == 0) {
            ...
            _lineView = [[UIView alloc] initWithFrame:CGRectMake(nameBtn.frame.origin.x, 38, btnWidth, 4)];
...
-(UITableViewCell *)customCellWithOutXib:(UITableView *)tableView withIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell == nil){
        ...
        //图片
        CGRect imageRect = CGRectMake(screenWidth/32*1.5, screenHeight/50*3, screenWidth/32*3, screenHeight/50*3);
       ...
       // layer.masksToBounds = YES;
        ...
        //标题
        CGRect titleTipRect = CGRectMake(screenWidth/32*6, screenHeight/50*1.5, screenWidth/32*4, screenHeight/50*1.5);
        UILabel *titleTipLabel = [[UILabel alloc]initWithFrame:titleTipRect];
        titleTipLabel.text = @"标题:";
        titleTipLabel.textColor = [UIColor whiteColor];
        titleTipLabel.font = [UIFont boldSystemFontOfSize:15*SizeScale];
        [cell.contentView addSubview:titleTipLabel];
        
        
        CGRect titleRect = CGRectMake(titleTipLabel.frame.origin.x+titleTipLabel.frame.size.width+5, screenHeight/50*1.5, screenHeight/50*15, screenHeight/50*1.5);
        ...
        CGRect contentTipRect = CGRectMake(screenWidth/32*6, screenHeight/50*3.5, screenWidth/32*4, screenHeight/50*1.5);
        UILabel *contentTipLabel = [[UILabel alloc]initWithFrame:contentTipRect];
        contentTipLabel.text = @"内容:";
        contentTipLabel.textColor = [UIColor whiteColor];
        contentTipLabel.font = [UIFont boldSystemFontOfSize:15*SizeScale];
        [cell.contentView addSubview:contentTipLabel];
        
        CGRect contentRect = CGRectMake(titleLabel.frame.origin.x, screenHeight/50*3.5, screenHeight/50*15, screenHeight/50*1.5);
        UILabel *contentLabel = [[UILabel alloc]initWithFrame:contentRect];
        contentLabel.textColor = [UIColor whiteColor];
        contentLabel.tag = 3;
        contentLabel.font = [UIFont boldSystemFontOfSize:15*SizeScale];
        [cell.contentView addSubview:contentLabel];
        //剩余次数
        
        CGRect oddtimesTipRect = CGRectMake(screenWidth/32*6, screenHeight/50*5.5, screenWidth/32*8, screenHeight/50*1.5);
        UILabel *oddtimesTipLabel = [[UILabel alloc]initWithFrame:oddtimesTipRect];
        oddtimesTipLabel.text = @"药品剩余:";
        oddtimesTipLabel.textColor = [UIColor whiteColor];
        oddtimesTipLabel.font = [UIFont boldSystemFontOfSize:15*SizeScale];
        [cell.contentView addSubview:oddtimesTipLabel];
        
        CGRect oddtimesRect = CGRectMake(titleLabel.frame.origin.x+20, screenHeight/50*5.5, screenWidth/32*15, screenHeight/50*1.5);
        UILabel *oddtimesLabel = [[UILabel alloc]initWithFrame:oddtimesRect];
        oddtimesLabel.tag = 4;
        oddtimesLabel.textColor = [UIColor whiteColor];
        
        oddtimesLabel.font = [UIFont boldSystemFontOfSize:15*SizeScale];
        [cell.contentView addSubview:oddtimesLabel];
       //查看
        
        CGRect  chakanTipRect = CGRectMake(screenWidth-screenWidth/32*4.5, screenHeight/50*3.5, screenWidth/32*3, screenHeight/50*1.5);
        UILabel *chakanTipLabel = [[UILabel alloc]initWithFrame:chakanTipRect];
        chakanTipLabel.text = @"查看";
        chakanTipLabel.textColor = [UIColor whiteColor];
        chakanTipLabel.font = [UIFont boldSystemFontOfSize:15*SizeScale];
        [cell.contentView addSubview:chakanTipLabel];
    ...
    //设置剩余剂量
    UILabel *oddtimesLabel = (UILabel *)[cell.contentView viewWithTag:4];
    oddtimesLabel.text = [dic objectForKey:@"expire_dose"];
    //设置右侧箭头
