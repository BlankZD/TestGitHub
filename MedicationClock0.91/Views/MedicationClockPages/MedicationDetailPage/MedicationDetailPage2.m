...
- (void)initViewWithData_week:(NSDictionary*)weekDic month:(NSDictionary*)monthDic year:(NSDictionary*)yearDic{
    ...
    weeklyReportTitle.font=[UIFont systemFontOfSize:18*SizeScale];
    ...
    weeklyReportYes.font=[UIFont systemFontOfSize:12*SizeScale];
    ...
    weeklyReportNo.font=[UIFont systemFontOfSize:12*SizeScale];
    ...
    weeklyReportZhou.font=[UIFont systemFontOfSize:20*SizeScale];
    ...
    mouthlyReportYue.font=[UIFont systemFontOfSize:20*SizeScale];
    ...
    mouthlyReportTitle.font=[UIFont systemFontOfSize:18*SizeScale];
    ...
    mouthlyReportYes.font=[UIFont systemFontOfSize:12*SizeScale];
    ...
    mouthlyReportNo.font=[UIFont systemFontOfSize:12*SizeScale];
    ...
    yearlyReportTitle.font=[UIFont systemFontOfSize:18*SizeScale];
    ...
    yearlyReportYes.font=[UIFont systemFontOfSize:12*SizeScale];
    ...
    yearlyReportNo.font=[UIFont systemFontOfSize:12*SizeScale];
    ...
    yearlyReportZhou.font=[UIFont systemFontOfSize:20*SizeScale];
