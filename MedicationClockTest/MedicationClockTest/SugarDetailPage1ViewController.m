...
- (void)viewDidLoad {
    ...
    UIView *before_meal_View = [[UIView alloc]initWithFrame:CGRectMake(0, screenHeight/3+15, screenWidth, screenHeight*8/50)];
    before_meal_View.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.6];
    ...
    before_meal_Label.font=[UIFont systemFontOfSize:17];
    ...
    before_meal_average_Label.font=[UIFont systemFontOfSize:12];
    ...
    before_meal_hyperglycaemia_Label.font=[UIFont systemFontOfSize:12];
    ...
    before_meal_hypoglycemia_Label.font=[UIFont systemFontOfSize:12];
    ...
    after_meal_View.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.6];
    ...
    after_meal_Label.font=[UIFont systemFontOfSize:17];
    ...
    after_meal_average_Label.font=[UIFont systemFontOfSize:12];
    ...
    after_meal_hyperglycaemia_Label.font=[UIFont systemFontOfSize:12];
