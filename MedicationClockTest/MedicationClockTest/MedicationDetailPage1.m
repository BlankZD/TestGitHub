...
-(void)initView:(NSDictionary*)dic{
    ...
    TitleView.backgroundColor=[UIColor colorWithWhite:1 alpha:0.6];
    ...
    ContentView.backgroundColor=[UIColor colorWithWhite:1 alpha:0.6];
    ...
    DateView.backgroundColor=[UIColor colorWithWhite:1 alpha:0.6];
    ...
    TimeView.backgroundColor=[UIColor colorWithWhite:1 alpha:0.6];
    [_scrollView addSubview:TimeView];
    
    UILabel *Timelabel1 = [[UILabel alloc]initWithFrame:CGRectMake(screenWidth/32*3, screenHeight/56.8*0.8,screenWidth/3.0,screenHeight/56.8*1.5)];
    ...
    UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake(screenWidth/32*0.8, TimeView.frame.origin.y+TimeView.frame.size.height, screenWidth-screenWidth/32*1.6, screenHeight/56.8*10) style:UITableViewStylePlain] ;
    // 设置tableView的数据源
    tableView.dataSource = self;
    // 设置tableView的委托
    tableView.delegate = self;
    
    tableView.backgroundColor=[UIColor colorWithWhite:1 alpha:0.6];
...
//            }
            ...
            [MedicationRecordDB_ insertDetail:dbDriver dic:dic];
            //掉用同步的函数
            ...
            [tableView reloadData];         //刷新列表视图控件显示的数据
        };
