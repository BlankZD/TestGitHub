...
-(UITableViewCell *)customCellWithOutXib:(UITableView *)tableView withIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell == nil){
        ...
        view1.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.6];
        ...
        view2.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.6];
        ...
        //竖线
        UIView *line1View = [[UIView alloc]initWithFrame:CGRectMake(32, 0, 5, 15)];
        line1View.backgroundColor = [UIColor whiteColor];
        [cell.contentView addSubview:line1View];
        UIView *line2View = [[UIView alloc]initWithFrame:CGRectMake(32, 55, 5, 65)];
