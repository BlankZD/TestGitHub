...
- (void)initView{
    ...
    UIView *systolic_pressure_View = [[UIView alloc]initWithFrame:CGRectMake(0, _heartRateChartView.frame.origin.y+_heartRateChartView.frame.size.height+screenWidth/22.0, screenWidth, screenHeight*1/6)];
    systolic_pressure_View.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.6];
    ...
    systolic_pressure_Label.font=[UIFont systemFontOfSize:17];
    ...
    [systolic_pressure_Label setFrame:CGRectMake(screenWidth/16, 5, systolic_pressure_LabelSize.width, systolic_pressure_LabelSize.height)];
    ...
    systolic_pressure_average_Label.font=[UIFont systemFontOfSize:12];
    ...
    systolic_pressure_hyperglycaemia_Label.font=[UIFont systemFontOfSize:12];
    ...
    systolic_pressure_hypotension_Label.font=[UIFont systemFontOfSize:12];
    ...
    UIView *diastolic_pressure_view = [[UIView alloc]initWithFrame:CGRectMake(0, systolic_pressure_View.frame.origin.y+systolic_pressure_View.frame.size.height+15, screenWidth, screenHeight*1/6)];
    diastolic_pressure_view.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.6];
    ...
    diastolic_pressure_Label.font=[UIFont systemFontOfSize:17];
    ...
    [diastolic_pressure_Label setFrame:CGRectMake(screenWidth/16, 5, diastolic_pressure_LabelSize.width, diastolic_pressure_LabelSize.height)];
    ...
    diastolic_pressure_average_Label.font=[UIFont systemFontOfSize:12];
    ...
    diastolic_pressure_hyperglycaemia_Label.font=[UIFont systemFontOfSize:12];
    ...
    diastolic_pressure_hypotension_Label.font=[UIFont systemFontOfSize:12];
    ...
    UIView *heart_rate_view = [[UIView alloc]initWithFrame:CGRectMake(0, diastolic_pressure_view.frame.origin.y+diastolic_pressure_view.frame.size.height+15, screenWidth, screenHeight*1/6)];
    heart_rate_view.backgroundColor=[UIColor colorWithWhite:1.0 alpha:0.6];
    ...
    heart_rate_Label.font=[UIFont systemFontOfSize:17];
    ...
    [heart_rate_Label setFrame:CGRectMake(screenWidth/16, 5, heart_rate_LabelSize.width, heart_rate_LabelSize.height)];
    ...
    heart_rate_average_Label.font=[UIFont systemFontOfSize:12];
    ...
    heart_rate_hyperglycaemia_Label.font=[UIFont systemFontOfSize:12];
    ...
    heart_rate_hypotension_Label.font=[UIFont systemFontOfSize:12];
