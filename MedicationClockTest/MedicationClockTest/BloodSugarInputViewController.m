...
- (void)initView{
    ...
    //健康小贴士
    UILabel *labelts = [[UILabel alloc]initWithFrame:CGRectMake(screenWidth/6, y0+screenHeight*3.4/5, screenWidth*2/3, screenHeight/56.8*6.5)];
...
//    labelts.lineBreakMode=UILineBreakModeWordWrap;
    ...
    labelts.layer.borderColor = [[UIColor whiteColor]CGColor];
    [labelts.layer setCornerRadius:5.0];
    labelts.layer.borderWidth = 0.5f;
    //labelts.layer.masksToBounds = YES;
    [self.view addSubview:labelts];
