...
- (void)viewDidLoad {
    ...
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, y0, screenWidth, screenHeight)];
    ...
    _itemDefs = @[
                  ...
                  @{
                      @"title": @"Test2",
                      @"subtitle": @"BloodSugarInputViewController",
                      @"class": BloodSugarInputViewController.class
                      },
                  @{
                      @"title": @"Test3",
...
//        viewController.paramDic = [NSDictionary dictionaryWithObjectsAndKeys:@"7", @"user_id", @"ls", @"username", nil];
        ...
        viewController.infoDict = [NSDictionary dictionaryWithObject:@"09:51" forKey:@"alarm_time"];
